...
export const protobufPackage = "wellai_bot.agent";
...
export const AgentServiceService = {
  ...
  receive: {
    path: "/wellai_bot.agent.AgentService/Receive" as const,
...
export interface AgentServiceServer extends UntypedServiceImplementation {
  /** Receive message from user (send by bot service) */
  receive: handleUnaryCall<Message, Response>;
}

export interface AgentServiceClient extends Client {
  /** Receive message from user (send by bot service) */
  receive(request: Message, callback: (error: ServiceError | null, response: Response) => void): ClientUnaryCall;
  receive(
    request: Message,
    metadata: Metadata,
